...
<html lang="PL">
	...
	<div id="preloader">
		...
		<div id="container">
		<h1 style="color:black;text-shadow: 1px 1px 10px black;margin-top: 100px;font-weight:900;font-size:40px;"> W jaki sposób możesz nam pomóc? </h1>
			<div id="faq">
				<ul>
					<li class="hh">Nagłaśnianie sprawy, aby dotarła do jak najszerszego grona osób.</li>
					<li class="hh">Przekazując datki na fundację (można to zrobić za pomocą formularza kontaktowego bądź kontaktu na miejscu czy telefonicznego).</li>
					<li class="hh">Lajkując nasze wydarzenia organizowane na rzecz innych - potrzebujących.</li>
				</ul>
			</div>
		</div>
