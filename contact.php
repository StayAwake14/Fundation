...
<html lang="PL">
	...
	<div id="preloader">
		...
		<div id="container">
		<h1 style="color:black;text-shadow: 1px 1px 10px black;margin-top: 100px;font-weight:900;font-size:40px;"> Jak możesz się z nami skontaktować? </h1>
			<div id="contact">
				<ul>
					<li class="cc">Siedziba: Ul. Złota 31, Warszawa</li>
					<li class="cc">Telefon: +48-444-444-444</li>
					<li class="cc">E-mail: f.grubcio@gmail.com</li>
					<li class="cc"></li>
					<li class="cc"></li>
				</ul>
			</div>
