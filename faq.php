...
<html lang="PL">
	...
	<div id="preloader">
		...
		<div id="container">
		<h1 style="color:black;text-shadow: 1px 1px 10px black;margin-top: 100px;font-weight:900;font-size:40px;"> Pomoc - najczęściej zadawane pytania </h1>
			<div id="faq">
				<ul>
					<li class="hh">Pytanie: W jaki sposób pomagamy?</li>
					<li class="hh">Odpowiedź: Pomagamy na wszelkie możliwe i dostępne sposoby, aby pomóc każdemu potrzebującemu. Organizujemy zbiórki pieniędzy i inne tego typu rzeczy.</li>
					<li class="hh">Pytanie: Od ilu lat już działamy?</li>
					<li class="hh">Odpowiedź: 18 lat.</li>
					<li class="hh">Pytanie: Ilu razy już pomogliśmy?</li>
					<li class="hh">Odpowiedź: Pomogliśmy już ponad 100 tyś. razy</li>
				</ul>
			</div>
		</div>
